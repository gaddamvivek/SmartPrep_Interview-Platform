...
// Static theoretical questions with difficulty levels and solutions
...
async function generateTheoreticalQuestions(prompt) {
  try {
...
async function seedDatabase() {
  ...
  console.log("-- MongoDB Database seeded with Static Theoretical Questions. --");
  ...
  for (const prompt of prompts) {
    const questionText = await generateTheoreticalQuestions(prompt);
    ...
    if (questionText) {
      try {
        ...
        await TechnicalQuestion.create({
          ...
          solution: questionText.solution,  // Insert the theoretical solution into the database
  ...
  console.log("-- MongoDB Database seeded with Generated Theoretical Questions. --");
  process.exit();
}
