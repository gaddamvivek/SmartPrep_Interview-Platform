      ...
      roles: [
        {
          ...
          description: 'Python Development (Level I)',
          id: 1,
          roundType: 'Coding',
        },
        {
          title: 'Python Developer II',
          description: 'Python Development (Level II)',
          id: 2,
          roundType: 'Coding',
        },
        {
        ...
        <div className="flex flex-col w-full h-full sm:flex-row items-center sm:items-start justify-start gap-8 mb-12">
          ...
          <div className="sm:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {company.roles.map((role) => (
              <div
                key={role.id}
                className="group bg-white shadow-md rounded-lg p-6 cursor-pointer hover:bg-gray-100"
                onClick={() => handleRoleSelect(role)}
              >
                <div className="mb-4 flex justify-center">
                  <img
                    src={`/${companyName === 'Google' ? 'google.png' : 'amazon.png'}`}
                    alt={`${role.title}`}
                ...
                <div
                  className="bg-purple-600 text-center text-white px-4 py-2 rounded-lg hover:bg-purple-700"
